...
**1. Who is the agent?**
Every agent gets its own identity, not a shared key. Using dedicated service accounts + Workload Identity Federation, each agent has a unique, verifiable identity tied to a service account in your GCP project.
